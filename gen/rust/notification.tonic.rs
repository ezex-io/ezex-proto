...
pub mod notification_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn send_templated_email(
            &mut self,
            request: impl tonic::IntoRequest<super::SendTemplatedEmailRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SendTemplatedEmailResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/notification.NotificationService/SendTemplatedEmail",
            );
...
pub mod notification_service_server {
    ...
    pub trait NotificationService: std::marker::Send + std::marker::Sync + 'static {
        async fn send_templated_email(
            &self,
            request: tonic::Request<super::SendTemplatedEmailRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SendTemplatedEmailResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/notification.NotificationService/SendTemplatedEmail" => {
                    ...
                    struct SendTemplatedEmailSvc<T: NotificationService>(pub Arc<T>);
                    impl<
                        T: NotificationService,
                    > tonic::server::UnaryService<super::SendTemplatedEmailRequest>
                    for SendTemplatedEmailSvc<T> {
                        type Response = super::SendTemplatedEmailResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as NotificationService>::send_templated_email(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let fut = async move {
                        let method = SendTemplatedEmailSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
